...
const NavBar = () => {
  return (
    <>
      <header className="sticky top-0 z-30 border-b border-black/5 bg-[color:rgba(246,239,229,0.78)] backdrop-blur-md">
      ...
      <nav className="fixed inset-x-4 bottom-4 z-30 flex items-center justify-center rounded-full border border-black/10 bg-[color:rgba(255,251,246,0.92)] p-2 shadow-[0_24px_50px_-28px_rgba(39,29,23,0.65)] backdrop-blur-md md:hidden">
